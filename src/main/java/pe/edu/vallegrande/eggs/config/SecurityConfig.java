    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(auth -> auth
                        ...
                        .pathMatchers(HttpMethod.GET, "/api/utilitydiary/**").hasAnyRole("USER", "ADMIN")
                        .pathMatchers(HttpMethod.POST, "/api/utilitydiary/**").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.PUT, "/api/utilitydiary/**").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.DELETE, "/api/utilitydiary/**").hasRole("ADMIN")
